...
exports.addProduct = asyncErrorHandler(async (req, res, next) => {
    ...
    try {
        ...
        const [result] = await connection.execute(`
            INSERT INTO products (name, category, price, offer_price)
            VALUES (?, ?, ?, ?)
        `, [name, category, parseFloat(price), offerPrice ? parseFloat(offerPrice) : null]);
...
exports.updateProduct = asyncErrorHandler(async (req, res, next) => {
    ...
    try {
        ...
        await connection.execute(`
            UPDATE products 
            SET name = ?, category = ?, price = ?, offer_price = ?, updated_at = CURRENT_TIMESTAMP
            WHERE id = ?
        `, [name, category, parseFloat(price), offerPrice ? parseFloat(offerPrice) : null, id]);
