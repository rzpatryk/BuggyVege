    ...
    const [loading, setLoading] = useState(false); 
     ...
     const handleSubmitLogin = async (event) => {
        ...
        setPostResponse(null);
         ...
         try{
            const response = await fetch('http://localhost:3000/api/v5/auth/login', {
                method: 'POST',
                credentials: 'include',
                headers: {
     ...
     const handleSubmitRegister = async (event) => {
        ...
        try{
            const response = await fetch('http://localhost:3000/api/v5/auth/register', {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type' : 'application/json'
...
export default LoginSessionMongo